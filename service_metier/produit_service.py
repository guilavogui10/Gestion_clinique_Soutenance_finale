"""
Module service métier pour la gestion des produits.

Centralise toute la logique métier (validation, CRUD, recherche,
mise à jour des prix) liée au catalogue de produits pharmaceutiques.
Suit le patron d'injection de dépendances : le DAO est injecté via
le constructeur.
"""
...
class ProduitService:
    ...
    la recherche, la mise à jour des prix et les informations cabinet.
    """

    # Types de produits autorisés dans le catalogue
    ...
    def __init__(self, dao=None, cabinet_dao=None):
        ...
        Args:
            dao: Instance de ProduitDAO (créée par défaut si non fournie).
    ...
    def valider_texte(self, texte: str, nom_champ: str, min_longueur: int = 3) -> tuple:
        ...
        Accepte les accents et caractères français (é, è, ê, à, ù, ç, etc.).
        """
        ...
        # Autorise lettres (y compris accentuées), chiffres, espaces, tirets, points
        # Refuse uniquement les caractères vraiment dangereux ou non médicaux
    ...
    def valider_prix(self, prix, nom_champ: str) -> tuple:
        """Valide qu'un prix est un nombre positif strictement supérieur à 0."""
        try:
    ...
    def valider_type(self, type_produit: str) -> tuple:
        """Valide que le type est parmi les valeurs autorisées."""
    ...
    def creer_produit(self, produit: Produit) -> tuple:
        """Valide et crée un nouveau produit dans le catalogue."""
    ...
    def modifier_produit(self, produit: Produit) -> tuple:
        """Valide et met à jour un produit existant."""
    ...
    def obtenir_libelle_par_code(self, code_produit: str) -> str:
        """
        Retourne le libellé d'un produit par son code.
        Utilisé pour remplir automatiquement le champ désignation
        dans le panier dès qu'un code_produit est sélectionné.
        Retourne une chaîne vide si le produit n'existe pas.
        """
    ...
    def obtenir_prix_achat_par_code(self, code_produit: str) -> float:
        ...
        Utilisé pour auto-remplir le champ prix dans le panier.
    ...
    def actualiser_prix_achat(self, code_produit: str, nouveau_prix: float) -> Tuple[bool, str]:
        """
        Valide et met à jour le prix d'achat d'un produit.
        Appelé après validation du panier si le prix fournisseur est différent.
        """
        # Validation du prix

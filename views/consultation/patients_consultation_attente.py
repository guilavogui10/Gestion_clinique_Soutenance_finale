"""
Patients en attente de consultation - meme logique que l'examen.
"""
...
class PatientCard(QFrame):
    ...
    def _setup_ui(self):
        ...
        champs = [
            ...
            ("fa5s.clock", "Att.", self._fmt_attente(self._get_value("temps_attente_minutes"))),
        ]
    ...
    @staticmethod
    def _fmt_attente(total_minutes) -> str:
        try:
...
class PatientsAttenteConsultationView(QWidget):
    ...
    def _setup_ui(self):
        ...
        self._h_title = QLabel("Patients en Attente de Consultation")
    ...
    def _build_empty_state(self) -> QWidget:
        ...
        self._empty_msg = QLabel("Aucun patient en attente de consultation pour cette session.")
    ...
    def _apply_theme(self):
        ...
        self._scroll.verticalScrollBar().setStyleSheet(ConsultationStyles.scrollbar())
...
class PatientsAttenteConsultationDialog(QDialog):
    ouvrir_nouveau_tab = Signal(str)

    def __init__(self, ctrl, code_session: str, parent=None):
        super().__init__(parent)
        self.setWindowTitle("Patients en Attente de Consultation")
        self.setModal(True)
    ...
    def _setup_ui(self, ctrl, code_session: str):
        ...
        self._title_lbl = QLabel("Patients en Attente de Consultation")
        ...
        self._view = PatientsAttenteConsultationView(ctrl, code_session, parent=self)
        self._view.ouvrir_formulaire.connect(self._on_ouvrir_formulaire)
        root.addWidget(self._view, 1)

    def _on_ouvrir_formulaire(self, code_visite: str):
        self.ouvrir_nouveau_tab.emit(code_visite)
        self.accept()

"""
Charts Section - 3 graphiques pour examen
1. Nombre d'examens par mois (barres)
2. Montant des examens par mois (scatter)
...
from views.examen.graphe_examen import (
    ExamenAnalyseGraph,
    MontantExamensGraph,
...
class ChartsSection(QWidget):
    ...
    def init_ui(self):
        ...
        # Graphique 1: Nombre d'examens par mois (barres)
        self.chart1_frame = self._create_chart_frame("Nombre d'examens par mois")
        self.chart1_graph = ExamenAnalyseGraph(self.chart1_frame, width=6, height=4, dpi=100)
        self.chart1_frame.layout().addWidget(self.chart1_graph)
        
        # Graphique 2: Montant des examens par mois (scatter)
        self.chart2_frame = self._create_chart_frame("Montant des examens par mois")
    ...
    def update_data(self, code_session):
        ...
        try:
            nombre_data = self.ctrl.obtenir_examens_par_mois(code_session)

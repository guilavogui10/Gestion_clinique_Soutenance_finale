...
class ChirurgieAnalyseGraph(BaseGraph):
    ...
    Usage dans ChirurgieView :
        self.graphe = ChirurgieAnalyseGraph(parent=self.frame_graph)
        self.graphe.update_graph(self.ctrl.obtenir_chururgies_par_mois(code_session))
    ...
    def update_graph(self, stats_mensuelles: dict):
        ...
        Parametre :
            stats_mensuelles (dict) : resultat de ctrl.obtenir_chururgies_par_mois()
        ...
        # Couleur rouge pour differencier visuellement de la vue Examen

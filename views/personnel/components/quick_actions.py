...
class QuickActions(QWidget):
    ...
    def init_ui(self):
        ...
        self.btn_new = self._create_button("Nouveau Personnel", "fa5s.plus-circle")
        ...
        # Connexions
        self.btn_new.clicked.connect(self.new_personnel_clicked.emit)
    ...
    def apply_theme(self):
        ...
        for btn in [self.btn_new, self.btn_refresh, self.btn_stats, self.btn_export]:
            ...
            if icon_name:
                color_map = {
                    "fa5s.plus-circle": c.get('success', c['primary']),
                    "fa5s.sync-alt": c.get('info', c['primary']),
                    "fa5s.chart-bar": c.get('primary', c['primary']),
                    "fa5s.file-export": c.get('warning', c['primary'])
                }
